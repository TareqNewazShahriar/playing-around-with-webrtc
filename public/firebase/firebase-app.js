!function(e, t) {
	...
	var o, s, c, f = (c = Error,
	r(o = p, s = c),
	void (o.prototype = null === s ? Object.create(s) : (l.prototype = s.prototype,
	new l)),
	p);
	function l() {
		 this.constructor = o
	...
	function p(e, t) {
		 ...
		 Error.captureStackTrace && Error.captureStackTrace(r, h.prototype.create),
		 r
	}
	var h = (y.prototype.create = function(e) {
		 ...
		 for (var n = t[0] || {}, i = this.service + "/" + e, o = this.errors[e], a = o ? function(e, n) {
			  ...
			  var p = u[l];
			  "_" !== p.slice(-1) && (p in c && console.warn('Overwriting FirebaseError base field "' + p + '" can cause unexpected behavior.'),
			  c[p] = n[p])
		 }
		 return c
	}
		 ...
		 return e(this, void 0, void 0, function() {
			  ...
			  return n(this, function(e) {
					...
					case 0:
						 ...
						 [4, Promise.all(t.filter(function(e) {
	...
	var R, P = (A.prototype.addComponent = function(e) {
	...
	var x, H = {
		 ...
		 error: C.ERROR,
		 silent: C.SILENT
	}, T = C.INFO, z = ((R = {})[C.DEBUG] = "log",
	R[C.VERBOSE] = "log",
	R[C.INFO] = "info",
	R[C.WARN] = "warn",
	R[C.ERROR] = "error",
	R), B = (Object.defineProperty(V.prototype, "logLevel", {
		 get: function() {
	...
	V.prototype.debug = function() {
		 for (var e = [], t = 0; t < arguments.length; t++)
			  e[t] = arguments[t];
		 this._userLogHandler && this._userLogHandler.apply(this, j([this, C.DEBUG], e)),
	...
	V.prototype.log = function() {
		 for (var e = [], t = 0; t < arguments.length; t++)
			  e[t] = arguments[t];
		 this._userLogHandler && this._userLogHandler.apply(this, j([this, C.VERBOSE], e)),
	...
	V.prototype.info = function() {
		 for (var e = [], t = 0; t < arguments.length; t++)
			  e[t] = arguments[t];
		 this._userLogHandler && this._userLogHandler.apply(this, j([this, C.INFO], e)),
	...
	V.prototype.warn = function() {
		 for (var e = [], t = 0; t < arguments.length; t++)
			  e[t] = arguments[t];
		 this._userLogHandler && this._userLogHandler.apply(this, j([this, C.WARN], e)),
	...
	V.prototype.error = function() {
		 for (var e = [], t = 0; t < arguments.length; t++)
			  e[t] = arguments[t];
		 this._userLogHandler && this._userLogHandler.apply(this, j([this, C.ERROR], e)),
	...
	var M, W = ((x = {})["no-app"] = "No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()",
	...
	x), G = new h("app","Firebase",W), $ = "@firebase/app", Y = "[DEFAULT]", K = ((M = {})[$] = "fire-core",
	...
	M), J = new B("@firebase/app"), Z = (Object.defineProperty(q.prototype, "automaticDataCollectionEnabled", {
		 get: function() {
	...
	function q(e, t, r) {
		 ...
		 this._addComponent(new _("app",function() {
			  return o
		 }
		 ,"PUBLIC"));
		 try {
	...
	function X(c) {
		 var l = {}
			...
			, p = {
			  ...
			  registerVersion: function(e, t, r) {
					var n, i = null !== (n = K[e]) && void 0 !== n ? n : e;
					r && (i += "-" + r);
					var o = i.match(/\s|\//)
					  , a = t.match(/\s|\//);
					if (o || a) {
						 var s = ['Unable to register library "' + i + '" with version "' + t + '":'];
						 return o && s.push('library name "' + i + '" contains illegal characters (whitespace or "/")'),
						 o && a && s.push("and"),
						 a && s.push('version name "' + t + '" contains illegal characters (whitespace or "/")'),
						 void J.warn(s.join(" "))
					}
		 ...
		 function h(r) {
			  var t, e, n = r.name;
			  if (u.has(n))
					return J.debug("There were multiple attempts to register component " + n + "."),
					"PUBLIC" === r.type ? p[n] : null;
			  if (u.set(n, r),
			  "PUBLIC" === r.type) {
					var i = function(e) {
						 if (void 0 === e && (e = f()),
